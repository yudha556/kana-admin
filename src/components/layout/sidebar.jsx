...
import { FileText, LayoutDashboard, Users, Activity, Bug, BookOpen } from "lucide-react";
...
export default function Sidebar() {
  ...
  const menus = [
    ...
    { name: "User Growth", icon: Users, href: "/users" },
    { name: "Reports", icon: FileText, href: "/reports" },
    { name: "Activity", icon: Activity, href: "/activity" },
    { name: "Bug Report", icon: Bug, href: "/bugs" },
    { name: "Quiz Activity", icon: BookOpen, href: "/quiz" },
  ];
